...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.stkResponse.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.stk-responses.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="receipt">{{ trans('cruds.stkResponse.fields.receipt') }}</label>
                <input class="form-control {{ $errors->has('receipt') ? 'is-invalid' : '' }}" type="text" name="receipt" id="receipt" value="{{ old('receipt', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('checkout_request') ? 'is-invalid' : '' }}" type="text" name="checkout_request" id="checkout_request" value="{{ old('checkout_request', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transaction_date') ? 'is-invalid' : '' }}" type="text" name="transaction_date" id="transaction_date" value="{{ old('transaction_date', '') }}">
